...
- класс KrasnopevtsevaVBubbleSortMPI с реализацией параллельной версии метода
- класс KrasnopevtsevaVBubbleSortSEQ с реализацией последовательной версии метода
